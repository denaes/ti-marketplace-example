...
description: >
  Plan and execute product launches and feature announcements for SaaS and technology products.
  Covers phased launch plans (alpha, beta, GA), channel strategy (owned/rented/borrowed), Product Hunt
  playbooks, launch day execution, and post-launch momentum. Use when launching a new product, major
