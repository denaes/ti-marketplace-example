...
name: proto-persona
description: >
  Create an initial, assumption-based persona profile that synthesizes available user research,
  market data, and stakeholder knowledge into a working hypothesis about your target user. Use this to
  align
metadata:
  type: skill
  department: product
