...
name: press-release
description: >
  Create a visionary press release following Amazon's "Working Backwards" methodology to define and
  communicate a product or feature before building it. Use this to align stakeholders on the customer
  va
metadata:
  type: skill
  department: product
