...
description: >
  Break down epics into user stories using Richard Lawrence's Humanizing Work methodology—a
  flowchart-driven approach that applies 9 splitting patterns sequentially.
metadata:
  type: skill
  department: product
