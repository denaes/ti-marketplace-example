...
> [Why does {{company_name}} exist? What drives you beyond making money?]
...
*What does {{company_name}} look like in 3 years? Be specific and measurable.*
...
[This section is managed by the `ceos-rocks` skill. Run "show our rocks" to see current status.]
...
[This section is managed by the `ceos-ids` skill. Run "show our issues" to see open issues.]
